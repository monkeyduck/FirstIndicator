...
<%
    ...
    if(exportToExcel != null && exportToExcel.toString().equalsIgnoreCase("YES")){
        ...
        response.setHeader("Content-Disposition","inline; filename=" + "validDailyUsedTime.xls");
    }
%>
...
<script type="text/javascript">
    function TableToExcel() {
        window.location.href = '<%=basePath%>stat/validDailyActiveTime?<%=url%>&exportToExcel=YES';
    }
</script>
</html>