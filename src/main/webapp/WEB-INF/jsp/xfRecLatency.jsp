...
<%
    ...
    if(exportToExcel != null && exportToExcel.toString().equalsIgnoreCase("YES")){
        ...
        response.setHeader("Content-Disposition","inline; filename=" + "recLatency.xls");
    }
%>
...
<script type="text/javascript">
    function TableToExcel() {
        window.location.href = '<%=basePath%>stat/xfRecLatency?<%=url%>&exportToExcel=YES';
    }
</script>
</html>