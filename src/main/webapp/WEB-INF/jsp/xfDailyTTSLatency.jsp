...
<%
    ...
    if(exportToExcel != null && exportToExcel.toString().equalsIgnoreCase("YES")){
        ...
        response.setHeader("Content-Disposition","inline; filename=" + "dailyTTSLatency.xls");
    }
%>
...
<script type="text/javascript">
    ...
    function displayLatency() {
        ...
        window.location.href = '<%=basePath%>stat/xfDailyTTSLatency?member_type='+member_type+'&version='+version+'&start_date='+begin+'&end_date='+end+'&type='+type;
    }
    ...
    function displayLatencyDetail(date) {
        ...
        var type = "date";
        if(begin == end) type = "hour";
        window.location.href = '<%=basePath%>stat/xfTTSLatency?member_type='+member_type+'&version='+version+'&date='+date+'&type='+type;
    }

    function TableToExcel() {
        window.location.href = '<%=basePath%>stat/xfDailyTTSLatency?<%=url%>&exportToExcel=YES';
    }
