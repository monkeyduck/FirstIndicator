...
<script type="text/javascript">
    ...
    function displayByDate() {
        var version = document.getElementById("versionSelect").value;
        var member_type = document.getElementById("userTypeSelect").value;
        window.location.href = '<%=basePath%>stat/sdk-first?member_type='+member_type+'&version='+version+'&type=date';
    }

    function displayByHour() {
        var version = document.getElementById("versionSelect").value;
        var member_type = document.getElementById("userTypeSelect").value;
        window.location.href = '<%=basePath%>stat/sdk-first?member_type='+member_type+'&version='+version+'&type=hour';
    }
    ...
    function TableToExcel() {
        window.location.href = '<%=basePath%>stat/sdk-first?<%=url%>&exportToExcel=YES';
    }
