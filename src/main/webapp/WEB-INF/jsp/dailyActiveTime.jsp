...
<%
    ...
    if(exportToExcel != null && exportToExcel.toString().equalsIgnoreCase("YES")){
        ...
        response.setHeader("Content-Disposition","inline; filename=" + "dailyUsedTime.xls");
    }
%>
...
<script type="text/javascript">
    function TableToExcel() {
        window.location.href = '<%=basePath%>stat/dailyActiveTime?<%=url%>&exportToExcel=YES';
    }
</script>
</html>